        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <div 
                key={project._id} 
                className="group bg-white rounded-3xl shadow-soft border border-cream-200 overflow-hidden hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 flex flex-col"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                {/* Project Image */}
                <div className="relative h-52 overflow-hidden bg-gradient-to-br from-cream-100 to-blush-100 flex-shrink-0">
                  ...
                  {/* Overlay on hover */}
                  <div className="absolute inset-0 bg-gradient-to-t from-warm-900/80 via-warm-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </div>
                
                {/* Project Content */}
                <div className="p-6 flex flex-col flex-grow">
                  <h3 className="font-heading text-xl sm:text-2xl font-bold text-warm-900 mb-3 group-hover:text-primary-600 transition-colors line-clamp-1">
                    {project.title}
                  </h3>
                  <p className="text-warm-600 text-sm sm:text-base mb-5 line-clamp-2 leading-relaxed">
                    {project.description || 'An amazing project showcasing creativity and technical skills'}
                  </p>
                  ...
                  {project.technologies && project.technologies.length > 0 && (
                    <div className="flex flex-wrap gap-2 mb-6">
                      {project.technologies.slice(0, 3).map((tech, techIndex) => (
                        <span
                          key={techIndex}
                          className="px-3 py-1.5 bg-gradient-to-r from-primary-50 to-blush-50 text-primary-700 text-xs font-semibold rounded-full border border-primary-200"
                        >
                          {tech}
                        </span>
                      ))}
                      {project.technologies.length > 3 && (
                        <span className="px-3 py-1.5 bg-cream-100 text-warm-600 text-xs font-semibold rounded-full border border-cream-200">
                          +{project.technologies.length - 3}
                        </span>
                      )}
                    </div>
                  ...
                  <div className="flex gap-3 mt-auto">
                    {project.githubLink && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 text-center text-sm bg-warm-800 hover:bg-warm-900 text-white py-3 px-4 rounded-xl transition-all font-semibold shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                      >
                    ...
                    {project.liveLink && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 text-center text-sm bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white py-3 px-4 rounded-xl transition-all font-semibold shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                      >
